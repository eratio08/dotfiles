...
ifPresent('packer', function(packer)
  ...
  packer.startup({
    function()
      ...
      use({ 'lewis6991/gitsigns.nvim', requires = { 'nvim-lua/plenary.nvim' } }) -- Git markers in sign column
      -- use('tpope/vim-rhubarb')-- GitHub integration
      use('numToStr/Comment.nvim') -- Commenting
      use('tpope/vim-unimpaired') -- ][ Movement helpers
      use('neovim/nvim-lspconfig') -- Language Server Protocol
      use('williamboman/mason.nvim') -- LSP manager
      use('williamboman/mason-lspconfig.nvim') -- lspconfig integration for mson
      use('nvim-lua/lsp_extensions.nvim')
      use('j-hui/fidget.nvim') -- LSP fidget
      ...
      use('p00f/nvim-ts-rainbow') -- rainbow coloring with tree sitter
      use('JoosepAlviste/nvim-ts-context-commentstring') -- commenting with tree sitter
      use('lukas-reineke/indent-blankline.nvim') -- Indentation guides
      -- use('mfussenegger/nvim-dap')-- Debug Adapter Protocol
      -- use('rcarriga/nvim-dap-ui')
      -- use('theHamsta/nvim-dap-virtual-text')
      -- use({ 'tami5/vlang.nvim', requires = { 'cheap-glitch/vim-v', 'nvim-lua/plenary.nvim' } })-- V Language
      -- use('edgedb/edgedb-vim')-- EdgeDB
